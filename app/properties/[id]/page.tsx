            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-5 gap-4">
                <div className="py-6 pr-6 col-span-3">
                    ...
                    <p className="mt-6 text-lg">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi unde inventore iste architecto delectus! Ipsum non quos mollitia quod eligendi quibusdam voluptate, autem excepturi provident inventore, laborum a ut est? 
                    </p>
                </div>
                <ReservationSidebar />
            </div>
